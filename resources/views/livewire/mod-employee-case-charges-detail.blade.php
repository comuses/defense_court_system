        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-5">
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            name="caseCharge.mod_id"
                            label="Mod"
                            wire:model="caseCharge.mod_id"
                        >
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.modID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.MIDnumber')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.rank')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.fullName')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.address')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.state')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.crimeType')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.crimeDate')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.chargeDate')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.mod_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_employee_case_charges.inputs.registrar_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
