        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-5">
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            name="decision.mod_id"
                            label="Mod"
                            wire:model="decision.mod_id"
                        >
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.case_hearing_decisions.inputs.caseHearingID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.case_hearing_decisions.inputs.modID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.case_hearing_decisions.inputs.empID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.case_hearing_decisions.inputs.name')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.case_hearing_decisions.inputs.chargeType')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.case_hearing_decisions.inputs.caseStartDate')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.case_hearing_decisions.inputs.decisionDate')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.case_hearing_decisions.inputs.decisionType')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.case_hearing_decisions.inputs.description')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.case_hearing_decisions.inputs.mod_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
