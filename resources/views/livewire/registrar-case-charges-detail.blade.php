            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.modID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.MIDnumber')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.rank')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.fullName')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.address')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.state')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.crimeType')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.crimeDate')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.chargeDate')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.mod_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.registrar_case_charges.inputs.mod_employee_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
