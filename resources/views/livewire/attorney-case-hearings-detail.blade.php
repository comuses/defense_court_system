        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-5">
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            name="caseHearing.witness_id"
                            label="Witness"
                            wire:model="caseHearing.witness_id"
                        >
                            <option value="null" disabled>Please select the Witness</option>
                            @foreach($witnessesForSelect as $value => $label)
                            <option value="{{ $value }}"  >{{ $label }}</option>
                            @endforeach
                        </x-inputs.select>
                    </x-inputs.group>
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.casehearingID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.modID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.courtID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.judgeID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.attorneyID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.attoneryWitnessID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.accusedWitnessID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.chilotname')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.accEmpID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.fileNumber')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.caseStartDate')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.address')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.state')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.location')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.description')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.court_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.mod_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.judge_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.attorney_case_hearings.inputs.witness_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
