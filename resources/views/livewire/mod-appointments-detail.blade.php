        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-5">
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            name="appointment.case_hearing_id"
                            label="Case Hearing"
                            wire:model="appointment.case_hearing_id"
                        >
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_appointments.inputs.caseHearID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_appointments.inputs.empID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_appointments.inputs.modID')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_appointments.inputs.fullname')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_appointments.inputs.chargeType')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_appointments.inputs.appointmentDate')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_appointments.inputs.description')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.mod_appointments.inputs.case_hearing_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
