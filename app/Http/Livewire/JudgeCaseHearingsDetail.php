...
class JudgeCaseHearingsDetail extends Component
{
    use WithPagination;
    ...
    {
        $this->editing = false;
        $this->modalTitle = trans('crud.judge_case_hearings.new_title');
        $this->resetCaseHearingData();
    ...
    {
        $this->editing = true;
        $this->modalTitle = trans('crud.judge_case_hearings.edit_title');
    ...
    public function save(): void
    {
        ...
        if (!$this->caseHearing->judge_id) {
            $this->authorize('create', CaseHearing::class);

            $this->caseHearing->judge_id = $this->judge->id;
        } else {
    ...
    public function toggleFullSelection(): void
    {
        ...
        foreach ($this->judge->caseHearings as $caseHearing) {
    ...
    {
        return view('livewire.judge-case-hearings-detail', [
            'caseHearings' => $this->judge->caseHearings()->paginate(20),
        ]);
    }
}
