...
class RegistrarsRelationManager extends RelationManager
{
    protected static string $relationship = 'registrars';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('MIDNumber')->limit(50),
                Tables\Columns\TextColumn::make('Rank')->limit(50),
                Tables\Columns\TextColumn::make('Name')->limit(50),
                Tables\Columns\TextColumn::make('fieldType')->limit(50),
